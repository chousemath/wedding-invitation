		...
		switch (msg.$) {
			...
			case 'GotPhotos':
				if (msg.a.$ === 'Ok') {
					...
					var comments = A2(elm$core$List$map, author$project$Main$extractComment, initialData.comments);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: author$project$Main$Errored('Internal Server Error')
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'ToggleSidebar':
...
var author$project$MyStyles$flexCenterX = _List_fromArray(
	[
...
var author$project$MyStyles$flexEndX = _List_fromArray(
	[
		rtfeldman$elm_css$Css$displayFlex,
		rtfeldman$elm_css$Css$flex(
		rtfeldman$elm_css$Css$num(1)),
...
var author$project$MyStyles$flexRowX = _List_fromArray(
	[
		rtfeldman$elm_css$Css$displayFlex,
		rtfeldman$elm_css$Css$flexDirection(rtfeldman$elm_css$Css$row)
	]);
var rtfeldman$elm_css$Css$flexStart = rtfeldman$elm_css$Css$prop1('flex-start');
var author$project$MyStyles$flexStartX = _List_fromArray(
	[
		rtfeldman$elm_css$Css$displayFlex,
		rtfeldman$elm_css$Css$flex(
		rtfeldman$elm_css$Css$num(1)),
...
var author$project$MyStyles$sty = {
	...
	iconCloseOverlay: _List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$px(30)),
			rtfeldman$elm_css$Css$height(
	...
	iconLoader: _List_fromArray(
		[
			rtfeldman$elm_css$Css$maxHeight(
			rtfeldman$elm_css$Css$px(150))
		]),
	iconSocial: _List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$px(30)),
			rtfeldman$elm_css$Css$height(
	...
	textContent: _List_fromArray(
		[
			rtfeldman$elm_css$Css$fontSize(
			rtfeldman$elm_css$Css$px(14))
		]),
	thumbnail: _List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$vw(100)),
			rtfeldman$elm_css$Css$height(
...
var author$project$Main$makeThumbnail = function (link) {
	return A2(
		...
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$class('glide__slide')
			]),
		_List_fromArray(
			[
				A2(
...
var author$project$Main$renderGallery = function (links) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$class('glide')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$class('glide__track'),
							A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-glide-el', 'track')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('glide__slides')
								]),
							A2(elm$core$List$map, author$project$Main$makeThumbnail, links))
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$class('glide__arrows'),
							A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-glide-el', 'controls')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('glide__arrow glide__arrow--left'),
									A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-glide-dir', '<')
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('이전')
								])),
							A2(
							rtfeldman$elm_css$Html$Styled$button,
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$class('glide__arrow glide__arrow--right'),
									A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-glide-dir', '>')
								]),
							_List_fromArray(
								[
