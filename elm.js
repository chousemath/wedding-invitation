			...
			[
				...
				_List_fromArray(
					[
						...
						_List_Nil),
						author$project$Main$renderSubtitle('2020.04.19 SUN AM 11:00'),
						author$project$Main$renderSubtitle('서울특별시 종로구 종로1길 50 (중학동)'),
						author$project$Main$renderSubtitle('더케이트윈타워 A동 LL층 (지하2층)')
					]))
			]));
};
